...
-- 추가 샘플 데이터 삽임
-- 가입일 -> SYSDATE로 삽입
INSERT INTO "MEMBER"  VALUES('MEM02', '123DFG', '김영희',
...
-- 0으로 시작될 가능성이 있으면 CHAR, VARCHAR2같은 문자열 타입으로 사용
...
CREATE TABLE "USER_USED_NN" (
 USER_NO NUMBER NOT NULL, -- 사용자 번호(모든 사용자는 사용자 번호가 반드시 있어야 한다)
 													-- 컬럼 레벨 제약조건 설정
 USER_ID VARCHAR2(20),
...
1, 'USER01', 'PASS01', '홍길동', '남자', '010-123-5678', 'hong_gd@or.kr'
);

INSERT INTO USER_USED_NN VALUES (
NULL, 'USER01', 'PASS01', '홍길동', '남자', '010-123-5678', 'hong_gd@or.kr'
);
...
INSERT INTO USER_USED_UK VALUES (
1, NULL, 'PASS01', '홍길동', '남자', '010-123-5678', 'hong_gd@or.kr'
);
...
INSERT INTO USER_USED_UK2 VALUES (
1, 'USER02', 'PASS01', '홍길동', '남자', '010-123-5678', 'hong_gd@or.kr'
);

INSERT INTO USER_USED_UK2 VALUES (
1, 'USER01', 'PASS01', '고길동', '남자', '010-123-5678', 'hong_gd@or.kr'
);
...
-- 복합키로 지정된 컬렁값 중 하나라도 다르면 위배되지 않음
--> 모든 컬럼의 값이 중복되면 위배된다!
...
INSERT INTO USER_USED_PK VALUES (
1, 'USER02', 'PASS02', '이순신', '남자', '010-2222-2222', 'lee_ss@or.kr'
);
-- SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH.USER_NO_PK)에 위배됩니다
--> 기본키 중복 오류!

INSERT INTO USER_USED_PK VALUES (
NULL, 'USER02', 'PASS02', '이순신', '남자', '010-2222-2222', 'lee_ss@or.kr'
);
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
--> 기본키 NULL 이므로 오류

INSERT INTO USER_USED_PK VALUES (
2, 'USER02', 'PASS02', '이순신', '남자', '010-2222-2222', 'lee_ss@or.kr'
);
...
1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr');

INSERT INTO USER_USED_PK2 VALUES (
1, 'USER02', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr');

INSERT INTO USER_USED_PK2 VALUES (
2, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr');
...
INSERT INTO USER_USED_PK2 VALUES (
NULL, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr');
-- SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2 VALUES (
3, NULL, 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr');
...
CREATE TABLE USER_USED_FK (
 ...
 REFERENCES USER_GRADE /*(USER_GRADE)*/ -- 컬럼레벨
 											-- 컬럼명 미작성 시 USER_GRADE 테이블의 PK를 자동참조함.
-- 테이블 레벨
 -- , CONSTRAINT GRADE_CODE_FK FROEIGN KEY(GRADE_CODE)
...
1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong_gd@or.kr', 10);
-- USER_GRADE(부모/참조테이블)에 10이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES (
2, 'USER02', 'PASS02', '이순신', '남자', '010-5678-1234', 'less_ss@or.kr', 10);
-- USER_GRADE(부모/참조테이블)에 10이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES (
3, 'USER03', 'PASS03', '유관순', '여자', '010-4321-5678', 'yoo_gs@or.kr', 30);
-- USER_GRADE(부모/참조테이블)에 30이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES (
4, 'USER04', 'PASS04', '안중근', '남자', '010-4321-8765', 'ahn_jg@or.kr', NULL);
--> NULL 사용 가능

INSERT INTO USER_USED_FK VALUES (
5, 'USER05', 'PASS05', '윤봉길', '남자', '010-6666-7777', 'yoon_bg@or.kr', 50);
...
CREATE TABLE USER_USED_FK3 (
 ...
 REFERENCES USER_GRADE3 ON DELETE SET NULL
 													/* 삭제옵션(삭제룰)*/
 );
...
INSERT INTO USER_USED_CHECK VALUES (
1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-5678', 'hong_gd@or.kr');

INSERT INTO USER_USED_CHECK VALUES (
2, 'USER02', 'PASS02', '유관순', '여', '010-1234-5678', 'hong_gd@or.kr');
